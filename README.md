# Website Templates – Reference Only

This repository contains **reference website templates** created for learning and practice purposes.
All templates are provided as **examples (REFERENCE ONLY)** to help students understand:
- HTML structure
- Multi-page navigation
- Basic CSS styling

⚠️ **Important Notice**
These templates are **NOT for direct submission**.  
Students must create their **own original work** based on these references.
...
## How to Download One Template Only

### Option 1: Download the full repository (Recommended for beginners)
1. Click **Code**
2. Select **Download ZIP**
3. Extract the ZIP file
4. Open the required template folder (e.g. `template-3`)
5. Open `index.html` in your browser

---

### Option 2: Download a specific template manually
...
Each template is independent and structured as follows:
  - `index.html`
  - `login.html`
  - `style.css`
